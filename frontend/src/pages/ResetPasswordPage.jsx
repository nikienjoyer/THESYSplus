...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setServerErr('');
    try {
      await client.post('/auth/reset-password/', { token, new_password: newPw });
      navigate('/sign-in?reason=password_set');
    } catch (err) {
        ...
        <div className={`rounded-2xl border p-6 sm:p-8 ${cardBg}`}>
          {invalidToken ? (
            ...
            <form onSubmit={handleSubmit} noValidate>
              {/* New password */}
              <div className="mb-4">
                <label htmlFor="rp-new" className={labelCls}>New Password</label>
              ...
              {/* Confirm password */}
              <div className="mb-5">
                <label htmlFor="rp-confirm" className={labelCls}>Confirm Password</label>
                <div className="relative">
                  <input id="rp-confirm"
